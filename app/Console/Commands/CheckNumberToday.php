...
class CheckNumberToday extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'email:checkNumber';
     ...
     * @var string
     */
    protected $description = 'Comprueba la salida de números de la Lotería de Florida';
